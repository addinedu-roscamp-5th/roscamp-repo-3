    ...
    def update_map(self):
        ...
        if self.show_trails:
            robot_colors = [
                ...
                QColor(255, 255, 100),  # 로봇 4 - 노란색
                QColor(255, 100, 255),  # 로봇 5 - 마젠타
                QColor(100, 255, 255)   # 로봇 6 - 시안
            ]
...
class IntegratedMainWindow(QMainWindow):
    ...
    def setup_map_section(self, main_layout):
        """맵 섹션 설정"""
        map_group = QGroupBox('1사분면: AMR 맵 + 로봇 제어')
    ...
    def setup_camera_section(self, main_layout):
        """카메라 섹션 설정"""
        cam_group = QGroupBox('2사분면: Live Camera + ArUco Detection')
    ...
    def setup_control_section(self, main_layout):
        """제어 파라미터 섹션 설정"""
        control_group = QGroupBox('3사분면: 제어 파라미터')
    ...
    def setup_status_section(self, main_layout):
        """상태 모니터링 섹션 설정"""
        status_group = QGroupBox('4사분면: 로봇 상태 모니터링')
