...
class GoalMover(Node):
    def __init__(self):
        ...
        self.declare_parameter('k_lin', 0.3)
        self.declare_parameter('k_ang', 0.1)
        self.declare_parameter('min_linear_speed', 0.55)
        ...
        self.goal_sub = self.create_subscription(PoseStamped, '/goalpose2', self.goal_callback, 10)
        self.odom_sub = self.create_subscription(Odometry, '/odom_2', self.odom_callback, 10)
